...
> 最后更新：2026-09-17 凌晨。C-2 / P1-37 / C-3 / C-4a-0 均已提交，C-4a 跑中。
...
- 测试：**62 文件 / 647 passed | 8 skipped | 5 todo，零红**，build 绿。
- **Phase D 全部完成**（P4-1 ~ P4-10）。
- **Phase C**：C-0 环路、C-1 房间剖面、C-2 湖泊、C-3 墙面与门、
  C-4a-0 四层地形模型 已完成；**C-4a（地形属性表 + 统一通行判据）跑中**。
...
| # | 轮次 | 状态 | 任务书 |
|---|---|---|---|
| 1 | **C-4a** 地形属性表 + 统一通行判据（吸收 P1-38/40） | 🟡 跑中 `wt-c-4a` | `tasks/c-4a.prompt.md` |
| 2 | **C-4a-1** 放开"每格只有一层非空" | ⬜ 待写 | 输入=C-4a-0 的 74 行干跑表 |
