...
> 最后更新：2026-09-17 下午。C-4 链完成；P1-42 / P1-46 / F-0 / F-1 已提交并推送。**F-2a 跑中**。
...
- 测试：**68 文件 / 745 passed | 8 skipped | 5 todo，零红**，build 绿。
...
- **Phase C**：C-0 环路、C-1 房间剖面、C-2 湖泊、C-3 墙面与门、
  ...
  **F 链跑中**：F-1 ✅ → **F-2a（放开 CE 火焰蔓延与寿命，真改玩法）跑中**
  → F-2b（生物燃烧状态机 + P1-44 抗火药水）→ F-2c（爆炸）→ G-1（气体）→ G-2。
...
| # | 轮次 | 状态 | 任务书 |
|---|---|---|---|
| 1 | **F-2a** 火焰蔓延 + 寿命 + 烧完产物（F-0 §5.3 的 1/2/3 条） | 🟡 跑中 `wt-f-2a` | `tasks/f-2a.prompt.md` |
| 2 | **F-2b** 生物燃烧状态机（§5.3-4）+ P1-44 抗火药水断线（§5.3-5） | ⬜ 待写 | |
