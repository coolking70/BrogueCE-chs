...
> 最后更新：2026-09-17 凌晨。C-4 链完成；F 链火侧走完；G-1 / G-2 已提交。**G-3 跑中**。
...
- 测试：**72 文件 / 807 passed 零红**，build 绿。
...
- **Phase C**：C-0 环路、C-1 房间剖面、C-2 湖泊、C-3 墙面与门、
  ...
  **气体侧**：G-1 迁层 + volume 量纲 + updateVolumetricMedia ✅
  → G-2 DF 接线 + 持续蒸汽源 + 燃气烧完留火 ✅
  → **G-3（效果阈值与比例伤害，生物侧）跑中** → **F-2c（爆炸 GAS_EXPLOSION）**
  ——F-2c 之后 F/G 链收口，可进入跨链并行。
...
| # | 轮次 | 状态 | 任务书 |
|---|---|---|---|
| 1 | **G-3** 气体效果阈值 + 比例伤害 + 五种未接效果（生物侧） | 🟡 跑中 `wt-g-3` | `tasks/g-3.prompt.md` |
