...
| # | 轮次 | 状态 | 任务书 |
|---|---|---|---|
| 1 | **B-2** 投掷（弹道/命中/回收，接 CE 的 `t` 键） | 🟡 跑中 `wt-b-2` | `tasks/b-2.prompt.md` |
| 2 | **C-7** 光照目录 + 矿灯深度衰减（**C 链收口**） | 🟡 跑中 `wt-c-7` | `tasks/c-7.prompt.md` |
| 3 | **B-3** 三占位卷轴 | ⬜ 待写 | B-0 说可与 B-2 并行 |
| 4 | **B-4** 生成规则对齐（**独占轮**，移动 RNG 流） | ⬜ 待写 | P1-50：金币恒 0、life 药水 10-15 只、dart 吃附魔 |
| 5 | **UI/渲染轮** | ⬜ 待写 | 已积五条：P1-47 裸键名 / EMBERS-ASH-PLAIN_FIRE 渲染 / 燃烧无视觉 / onConfirmRequest / 地面符号 |
| — | 中小 P1：P1-39 深水可游 / P1-41 成员铺开改路径距离 / C-4a-1 收敛通行判据 / i18n 扫描器模板字符串盲区 | ⬜ | 可合并 |
