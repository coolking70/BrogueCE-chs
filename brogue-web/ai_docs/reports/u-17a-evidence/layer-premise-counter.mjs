...
variants.splice(0, variants.length, {name:'head-layer-table', head:true, files:['src/test/c_4a_0_layer_model.test.ts'], test:'归属表与 drawPriority'});
const requested=['head-layer-table'];
