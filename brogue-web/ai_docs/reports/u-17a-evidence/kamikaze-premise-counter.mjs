...
variants.splice(0, variants.length, {name:'head-kamikaze-premise', head:true, files:['src/test/p4_4_split_kamikaze.test.ts'], test:'F-2c 翻转：爆炸伤害瞬时'});
const requested=['head-kamikaze-premise'];
