...
variants.splice(0, variants.length, {name:'head-late-premises', head:true, files:['src/engine/Combat/BoltContract.test.ts','src/test/u_15a_shattering.test.ts','src/test/hunger_curve_sim.test.ts']});
const requested=['head-late-premises'];
