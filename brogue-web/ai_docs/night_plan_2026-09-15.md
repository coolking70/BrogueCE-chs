...
| # | 轮次 | 状态 | 任务书 |
|---|---|---|---|
| 1 | **P4-6** 矛/斧/鞭 怪物侧攻击几何 | 🟡 跑中（09-15 23:0x 投） | `ai_docs/tasks/p4-6.prompt.md` |
| 2 | **P4-7** 玩家武器几何 + 钝器击退 | ⬜ 待投 | `ai_docs/tasks/p4-7.prompt.md` |
| 3 | **P4-8** 气味图（scent map） | ⬜ 待投 | `ai_docs/tasks/p4-8.prompt.md` |
