...
const out='ai_docs/reports/u-17e-evidence',file='src/test/fixtures/generation_baseline.json';
...
after.note='U17e: CE altar cages, commutation and resurrection carriers, magic piping and sacrifice chain; independent trigger guards and ordered per-lever generation attribution in u-17e.report.md.';
