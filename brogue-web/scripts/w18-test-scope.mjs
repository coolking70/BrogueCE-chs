// Run from brogue-web: R(actual production files) + W-0 S(C,M,U,B) + entrancement/action/save consumers, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts','src/entities/Creature.ts','src/entities/Monster.ts','src/engine/Combat/Combat.ts','src/engine/Movement/Entrancement.ts','src/engine/Movement/CreaturePlacement.ts','src/engine/Combat/BoltTargeting.ts','src/engine/Status/statusConfig.ts','src/components/GameCanvas.vue','src/locales/zh_CN.json'];
...
const patterns = {
    ...
    U: /handlePlayerAction|useArcanaItem|throwItem|Input|statusConfig|GameCanvas/,
    entrancement: /entranc|confus|seized|seizing|falling|monstersFall|placeCreature|dormant|captive|saveSnapshot|loadSnapshot|toSnapshot/,
