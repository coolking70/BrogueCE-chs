...
const gates=[
 ['ce-golden','node',['scripts/u13-ce-golden.mjs']],
 ['audit','node',['scripts/u13-audit.mjs']],
 ['counterfactual','node',['scripts/u13-negative-check.mjs']],
 ['build','npm',['run','build']],
...
for(const [name,cmd,args] of gates){
 ...
 if (r.status !== 0 && name !== 'regression') break;
}
