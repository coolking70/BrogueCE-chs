...
const out='ai_docs/reports/u-19c-evidence';
...
const pattern=/HAS_ITEM|HAS_MONSTER|HAS_PLAYER|HAS_STAIRS|hasPendingOccupant|fillVestibuleInterior|fillAreaInterior|mapMachineInterior|cellIsFeatureCandidate|randomMatchingLocation|runAutogenerators|MachineEntityRuntime|createMachineRuntime|spawnHordeAtFeature|spawnHordeAt|finalizeBlueprintMonster|abortItemsAndMonsters|AMULET|populateLevel|pendingItems|pendingMonsters|buildAMachine|blueprintQualifies|readFileSync|readFile/;
