...
const out='ai_docs/reports/u-19d-evidence';
...
const pattern=/WALL_LEVER|TRAP_DOOR|MEDIUM_HOLE|PARALYSIS|CRACKING_STATUE|STATUE_DORMANT|isThrowingTutorialReward|HAS_ITEM|HAS_MONSTER|HAS_PLAYER|HAS_STAIRS|hasPendingOccupant|fillVestibuleInterior|fillAreaInterior|mapMachineInterior|cellIsFeatureCandidate|randomMatchingLocation|runAutogenerators|MachineEntityRuntime|createMachineRuntime|spawnHordeAtFeature|spawnHordeAt|finalizeBlueprintMonster|abortItemsAndMonsters|AMULET|populateLevel|pendingItems|pendingMonsters|buildAMachine|blueprintQualifies|readFileSync|readFile/;
