...
const pattern=/IN_VIEW_OF_ORIGIN|IN_PASSABLE_VIEW_OF_ORIGIN|featureView|cellIsFeatureCandidate|computeMachineView|computeFOVMask|pendingItems|pendingMonsters|buildAMachine|blueprintQualifies|readFileSync|readFile/;
