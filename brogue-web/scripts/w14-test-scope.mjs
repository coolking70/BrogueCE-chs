// Run from brogue-web: R(actual production files) + W-0 S(B,D) + obstruction/forcefield/path caches, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Map/Promotion.ts', 'src/engine/Map/DungeonFeatureCatalog.ts', 'src/engine/Map/TerrainCatalog.ts'];
...
const patterns = {
    ...
    obstruction: /obstruction|OBSTRUCTION|forcefield|FORCEFIELD|[Ii]mpregnable|IMPREGNABLE|shatter|crystalize|[Ww]aypoint|[Ll]oopMap|[Cc]onnectivity|[Ss]afetyMap|autoPath/,
