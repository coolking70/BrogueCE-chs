...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Combat/Bolt.ts', 'src/locales/zh_CN.json', 'src/locales/zh_CN.legacy.json'];
...
const patterns = {
    ...
    effects: /applyBasicBoltEffect|slowed|hasted|haste|discordant|invisible|HEALING|DISCORD|autoID|healing/,
