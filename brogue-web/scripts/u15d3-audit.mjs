...
const seeds=['src/engine/Items/ItemLoader.ts','src/engine/Items/Item.ts','src/engine/UI/DetailGenerator.ts'];
const pattern=/RUNIC|runic|vorpalEnemy|spawnWeapon|spawnArmor|MF_REQUIRE_GOOD_RUNIC|multiplicity|slowing|plenty|burden|vulnerability|immolation|slaying|readFileSync|readFile/;
...
const mandatory=files.filter(f=>/\/test\/(p1_30|u_?24|u_01|u_03|u_05|u_15d|u_16|armor_runic|b_4a|w_(20|23)_|u_r[24])/.test(f));
