// Run from brogue-web: R(actual production files) + W-0 S(M,B) + domination/save/consumers, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/entities/Monster.ts', 'src/engine/Combat/Domination.ts', 'src/engine/Combat/BoltTargeting.ts', 'src/components/GameCanvas.vue', 'src/locales/zh_CN.json'];
...
const patterns = {
    ...
    domination: /dominat|freeCaptive|becomeAlly|carriedItem|seized|seizing|summon|split|dormant|captive|saveSnapshot|loadSnapshot|toSnapshot/,
