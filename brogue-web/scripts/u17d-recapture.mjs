...
const out='ai_docs/reports/u-17d-evidence',file='src/test/fixtures/generation_baseline.json';
...
after.note='U17d: CE vents, pilot light, poison/fire traps and armor immolation catalog; independent trigger guards and ordered per-lever generation attribution in u-17d.report.md.';
