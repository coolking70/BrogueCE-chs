// Run from brogue-web: R(actual production files) + W-0 S(M,B,C) + conjuration/save, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/entities/Monster.ts', 'src/engine/Combat/Conjuration.ts', 'src/components/GameCanvas.vue'];
...
const patterns = {
    ...
    conjuration: /conjur|spectral_blade|summon|split|negat|dormant|captive|stairs|saveSnapshot|loadSnapshot|toSnapshot/,
