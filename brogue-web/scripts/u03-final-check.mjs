...
run('scope','node',['scripts/u03-test-scope.mjs']);
run('audit','node',['scripts/u03-audit.mjs']);
run('counterfactual','node',['scripts/u03-counterfactual.mjs']);
run('measure','node',['scripts/u03-run-measure.mjs']);
