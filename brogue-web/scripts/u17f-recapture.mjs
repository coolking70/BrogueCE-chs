...
const out='ai_docs/reports/u-17f-evidence',file='src/test/fixtures/generation_baseline.json';
...
after.note='U17f: CE cracking walls/statues, coffins, portal light, retracting altar and worm tunnel carriers plus RUBBLE autogen; independent trigger guards and ordered per-lever generation attribution in u-17f.report.md.';
