/** W-5 repeatable observation probe. Bundle with esbuild; run with an output path. */
...
const seeds = [42, 12345, 20250308, 999, 1, 7, 20260914, 20260923];
const rows: any[] = [];
let attempts: any[] = [];
...
log(`W-5 sampled ${rows.length} levels -> ${process.argv[2]}`);
