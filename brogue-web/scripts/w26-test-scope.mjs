// Run from brogue-web: R(actual inputs) + W-0 S(G,Q,B,U,D,C), identity/save/flavor consumers and source/fixture readers.
import ts from 'typescript';
import { execFileSync } from 'node:child_process';
import fs from 'node:fs';
import path from 'node:path';
const dir = 'ai_docs/reports/w-26-evidence';
...
const planned = ["src/data/arcana.json", "src/engine/Items/ItemLoader.ts", "src/engine/Combat/Bolt.ts", "src/locales/zh_CN.json", "src/engine/Items/ArcanaRecharge.ts"];
