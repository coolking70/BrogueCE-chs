// Run from brogue-web: R(actual production files) + W-0 S(B,C), plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Combat/Bolt.ts', 'src/engine/Combat/StaffDamage.ts'];
...
const patterns = {
    ...
    effects: /staffDamage|rollStaffDamage|magnitude|immune_fire|INVULNERABLE|trySplitMonster|burning|revenant/,
