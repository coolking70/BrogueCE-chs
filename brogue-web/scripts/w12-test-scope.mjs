// Run from brogue-web: R(actual production files) + W-0 S(B,M,D,C) + blink/beckoning/pickup/fall, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Combat/BoltTrajectory.ts'];
...
const patterns = {
    ...
    movement: /blink|Blink|BLINK|beckon|Beckon|BECKON|pickUpItem|fall|Fall|captive|Captive|isCaged|placeCreature|freeCaptive|ticksUntilTurn/,
