// Run from brogue-web: R(actual production files) + W-0 S(M,C,B) + polymorph/identity/save consumers, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts','src/entities/Monster.ts','src/engine/Combat/Bolt.ts','src/engine/Combat/Polymorph.ts'];
...
const patterns = {
    ...
    polymorph: /polymorph|mutation|carriedMonster|carriedItem|typeId|deathEffectTriggered|seized|seizing|dormant|captive|saveSnapshot|loadSnapshot|toSnapshot/,
