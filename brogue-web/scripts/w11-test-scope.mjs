// Run from brogue-web: R(actual production files) + W-0 S(B,M,D,Q) + teleport/fall/captive, plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Movement/CreaturePlacement.ts', 'src/engine/Map/Promotion.ts'];
...
const patterns = {
    ...
    movement: /teleport|Teleport|TELEPORT|fall|Fall|captive|Captive|isCaged|placeCreature|freeCaptive/,
