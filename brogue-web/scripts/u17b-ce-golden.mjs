...
const names=['TRAMPLED_FOLIAGE','ACTIVE_BRIMSTONE','BRIMSTONE_FIRE','OPEN_IRON_DOOR_INERT','BRIDGE_FALLING'];
const tiles={};
...
const dfs={};
for(const name of ['DF_TRAMPLED_FOLIAGE','DF_ACTIVE_BRIMSTONE','DF_BRIMSTONE_FIRE','DF_OPEN_IRON_DOOR_INERT','DF_BRIDGE_FALL_PREP','DF_FOLIAGE_REGROW','DF_INERT_BRIMSTONE','DF_BRIDGE_FALL','DF_BRIDGE_FIRE']){
...
const file='src/test/fixtures/u17b-ce-catalog.json';
...
console.log('CE oracle: 5 tiles / 9 DF rows');
