...
const out='ai_docs/reports/u-17b-evidence',file='src/test/fixtures/generation_baseline.json';
...
after.note='U17b: CE vegetation/brimstone/iron-door/bridge carriers; foliage regrowth and stationary floor-item promotion; per-carrier attribution and independent trigger guards recorded in u-17b.report.md.';
