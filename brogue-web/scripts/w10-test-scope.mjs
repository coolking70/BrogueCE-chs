// Run from brogue-web: R(actual production files) + W-0 S(B,C,Q,M), plus source/fixture readers.
...
const seeds = ['src/engine/Core/Game.ts', 'src/engine/Combat/Combat.ts', 'src/engine/Combat/Bolt.ts', 'src/engine/Combat/Poison.ts', 'src/entities/Creature.ts', 'src/entities/Monster.ts', 'src/entities/Player.ts', 'src/locales/zh_CN.json', 'src/components/GameCanvas.vue'];
...
const patterns = {
    ...
    poison: /poison|Poison|MA_POISONS|hunger_regen|regen|Regen/,
